...
def score(dice)
  # You need to write this method
	# может прийти от 0 до 5 значений	
	# три единицы(1) = 1000 балов
	# просто единица(1)(если она не в тройке) = 100 балов
	# пятёрка = 50 балов	
	# три одинаковые числа(x)(кроме единицы) = x * 100 балов
	result = 0
